...
public class BoardController {
	...
	public ModelAndView getList(@RequestParam(value="pageNum", defaultValue="1")int currnetPage) {
	...
	//페이지 처리
	PagingUtil page = new PagingUtil(currnetPage,count,10,10,"list.do");
	...
	public String submitDelete(@Valid BoardVO vo, BindingResult result) {
		//유효성 체크결과 오류가 있으면 폼을 호출 (비밀번호 전송 여부만 체크 )
