...
public interface BoardMapper {
	...
	//좋아요
	@Select("SELECT * FROM spboard_fav WHERE "
		  + "board_num=#{board_num} AND mem_num=#{mem_num}")
	...
	@Insert("INSERT INTO spboard_fav (fav_num,"
		  + "board_num,mem_num) VALUES (spfav_seq.nextval,"
		  + "#{board_num},#{mem_num})")
	...
	@Insert("INSERT INTO spboard_reply (re_num,re_content,"
		  ...
		  + "spreply_seq.nextval,#{re_content},#{re_ip},"
		  + "#{board_num},#{mem_num})")
