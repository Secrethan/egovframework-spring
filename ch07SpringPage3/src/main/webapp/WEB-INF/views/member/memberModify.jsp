	...
	<form:form action="update.do" id="modify_form"
		...
		<ul>
			...
			<li> 
				...
				<form:checkbox path="f_hobby" value="영화감상"/>영화감상
				<form:checkbox path="f_hobby" value="음악감상"/>음악감상
				<form:checkbox path="f_hobby" value="독서"/>독서
				<form:checkbox path="f_hobby" value="운동"/>운동
			</li>
			<li>
